...
const paths = [
  ...
  { path: "/tools/image-converter", changeFrequency: "monthly" as const, priority: 0.72 },
  { path: "/tools/social-resize", changeFrequency: "monthly" as const, priority: 0.72 },
  { path: "/tools/watermark-tool", changeFrequency: "monthly" as const, priority: 0.72 },
  { path: "/tools/jpg-pdf-tool", changeFrequency: "monthly" as const, priority: 0.72 },
  {
  ...
  { path: "/tools/prompt-enhancer", changeFrequency: "monthly" as const, priority: 0.72 },
